...
def updateVariantDoc(self, document_id, update_spec, namespace, timestamp):
    self.commit()
    document_id = update_spec['sku']+"_"+str(update_spec['facility_id'])
    index, doc_type = self._index_and_mapping(namespace)

    document = self.elastic.get(index="catalog", doc_type="variant",
                                            id=u(document_id))
    finalUpdatedElasticDoc = document
    if doc_type:
        if doc_type == "facility_variant":
            finalUpdatedElasticDoc['mrp'] = update_spec['mrp']
            finalUpdatedElasticDoc['selling_price'] = update_spec['selling_price']
            finalUpdatedElasticDoc['discount'] = update_spec['discount']
            finalUpdatedElasticDoc['rack_details'] = update_spec['rack_details']
            finalUpdatedElasticDoc['status'] = update_spec['status']
        elif doc_type == "variant":
            finalUpdatedElasticDoc['eg_sku'] = update_spec['eg_sku']
            finalUpdatedElasticDoc['eg_product_name'] = update_spec['eg_product_name']
            finalUpdatedElasticDoc['pack_type'] = update_spec['pack_type']
            finalUpdatedElasticDoc['pack_size'] = update_spec['pack_size']
            finalUpdatedElasticDoc['name'] = update_spec['name']
            finalUpdatedElasticDoc['status'] = update_spec['status']
            finalUpdatedElasticDoc['is_discontinue'] = update_spec['is_discontinue']
            finalUpdatedElasticDoc['pack_size_unit'] = update_spec['pack_size_unit']
            finalUpdatedElasticDoc['is_available'] = update_spec['is_available']
            finalUpdatedElasticDoc['is_cold_storage'] = update_spec['is_cold_storage']
            finalUpdatedElasticDoc['is_retired'] = update_spec['is_retired']
            finalUpdatedElasticDoc['thumbnail_image'] = update_spec['thumbnail_image']
            finalUpdatedElasticDoc['consumption_per_day'] = update_spec['consumption_per_day']
            finalUpdatedElasticDoc['images'] = update_spec['images']
